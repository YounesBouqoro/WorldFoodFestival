const CACHE_NAME='wff-pos-shell-v26';
const LOCAL_ASSETS=[
  ...
  './offline-store.js','./index.js','./app.js','./pos-enhancements.js','./pos-enhancements.js?v=20260912-1','./returns.js','./admin.js','./admin-enhancements.js','./admin-enhancements.js?v=20260912-1','./receipt.js','./pwa.js','./manifest.webmanifest','./apple-touch-icon-wff-original-v3.png','./app-icon-192.png','./apple-touch-icon.png','./app-icon.svg','./app-icon-maskable.svg'
];
